...
import HeroSection from "../components/HeroSection"; // Assuming this will be rewritten to fit EnTec's message
import RouteSection from "../components/RouteSection"; // Not used, keep commented
import HowItWorks from "../components/HowItWorks"; // Not used, keep commented
import { Footer } from "../components/Footer"; // Assuming this exists
import PomodoroTimer from "../components/PomodoroTimer "; // Assuming this exists (remove if irrelevant)
